...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "firebase": {
        "firebase_database_url": "https://aqua-9e38e-default-rtdb.firebaseio.com",
    },
}
...
# Firebase Credentials Path (supports serviceAccountKey.json or firebase_credentials.json)
FIREBASE_CREDENTIALS_PATH = BASE_DIR / "serviceAccountKey.json"
for _cand in [BASE_DIR / "serviceAccountKey.json", BASE_DIR / "firebase_credentials.json", DATA_DIR / "serviceAccountKey.json", DATA_DIR / "firebase_credentials.json"]:
    if _cand.exists():
        FIREBASE_CREDENTIALS_PATH = _cand
        break
